        ...
        <div className="page-wrapper">
            <div className="page-header">
                ...
                <p className="about-text-new">
                    Everything you need to deploy SEVE in your environment. From quick start guides to technical specifications,
            ...
            <section className="section-wrapper" style={{ paddingTop: '5rem' }}>
                <div className="problem-grid">
                    <div className="problem-card">
                        ...
                        <p>Get SEVE running in under 10 minutes. System requirements, installation steps, and first scan walkthrough. Available for Windows desktop and Android mobile.</p>
                    </div>
                    <div className="problem-card">
                        <h3>🤖 AI Features</h3>
                        <p>Understanding SEVE's embedded AI content analysis. How it reads files, assigns confidence scores, and operates 100% offline. Supported file formats and OCR capabilities.</p>
                    </div>
                    <div className="problem-card">
                    ...
                    <div className="problem-card solution-card">
                        ...
                        <p>Technical specs for SEVE Hardware Device. Processor requirements, NPU acceleration, storage controller interfaces, and bootable USB creation guide.</p>
                    </div>
                    <div className="problem-card">

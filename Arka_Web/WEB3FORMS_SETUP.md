# Web3Forms Setup Guide for Arka Form
...
1. **User submits Arka form** → Form data collected
...
```
Subject: 🔒 New Arka Request from [User Name]
...
🎯 Purpose:
We need Arka for secure data destruction in our data center. 
...
The Arka form now uses Web3Forms for reliable email delivery. The integration is:

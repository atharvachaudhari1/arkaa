      ...
      <div className="footer-content">
        <div className="footer-column footer-brand">
          <div className="footer-logo-text">
            <img src={ArkaIcon} alt="Arka" height="32" style={{ filter: 'invert(1)' }} />
            <span>Arka</span>
          </div>
        ...
        <div className="footer-column">
          ...
          <ul className="footer-links">
            ...
            <li><a href="https://github.com/Utsav-Singh-35/Arka-Release" target="_blank" rel="noopener noreferrer">Github <span>→</span></a></li>
          </ul>
        </div>

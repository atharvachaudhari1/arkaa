      ...
      <div className="footer-content">
        <div className="footer-column footer-brand">
          ...
          <div className="footer-company">
            ...
            <p className="detail-value" style={{ fontSize: '0.85rem', opacity: 0.6 }}>Atharva · Allan · Saanvi · Junaid · Elish · Rachel — six developers building the future, one project at a time.</p>
          </div>
        </div>
      </div>
    </footer>
